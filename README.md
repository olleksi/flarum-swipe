...
англійської я не знаю, цей опис робив ші, тож якщо там якась дурні - вибачайте. якщо коротко то це розширення яке дозволяє свайпом повертатись на попередню сторінку або відкрити меню.
